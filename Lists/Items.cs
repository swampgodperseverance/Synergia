...
namespace Synergia.Lists {
    public class Items {
        ...
        public static List<int> WeaponActiveBlood { get; private set; } = [Shuriken, BloodyMachete, StarAnise, ShadowFlameKnife, FlyingKnife, Javelin, FrostDaggerfish, BoneJavelin, BoneDagger, Bananarang, PossessedHatchet, ScourgeoftheCorruptor, LightDisc, ThrowingKnife, Horizons.Find<ModItem>("GammaBlade").Type, Horizons.Find<ModItem>("BoneKama").Type, Horizons.Find<ModItem>("PalladiumWaraxe").Type, Horizons.Find<ModItem>("MoltenDagger").Type, Horizons.Find<ModItem>("Kunai").Type, Horizons.Find<ModItem>("RustyAxe").Type, Horizons.Find<ModItem>("BloodSpiller").Type, Horizons.Find<ModItem>("CobaltKunai").Type, Bis.Find<ModItem>("JaguarsChakram").Type, Bis.Find<ModItem>("OrcishJavelin").Type, Bis.Find<ModItem>("ThrowingAxe").Type, Bis.Find<ModItem>("Typhoon").Type, Bis.Find<ModItem>("FuryOfWaters").Type, Bis.Find<ModItem>("SharkJavelin").Type, Bis.Find<ModItem>("SharkKnife").Type, Bis.Find<ModItem>("OrichalcumJavelin").Type, Bis.Find<ModItem>("MythrilJavelin").Type, Bis.Find<ModItem>("ChlorophyteJavelin").Type, Bis.Find<ModItem>("TitaniumJavelin").Type, Bis.Find<ModItem>("CobaltJavelin").Type, Bis.Find<ModItem>("StarOfTheDunedain").Type, Bis.Find<ModItem>("AdamantiteJavelin").Type, Valhalla.Find<ModItem>("TarBlade").Type, Bis.Find<ModItem>("SolarDisk").Type, Bis.Find<ModItem>("JaguarsDagger").Type, Valhalla.Find<ModItem>("DemoniteGlaive").Type, Valhalla.Find<ModItem>("TrueNightGlaive").Type, Valhalla.Find<ModItem>("NightGlaive").Type, Valhalla.Find<ModItem>("ChlorophyleGlaive").Type, Valhalla.Find<ModItem>("DungeonGlaive").Type, Valhalla.Find<ModItem>("BigBeeNade").Type, Valhalla.Find<ModItem>("Sufferang").Type, Valhalla.Find<ModItem>("CarrotDagger").Type, Valhalla.Find<ModItem>("CactusKnife").Type, Valhalla.Find<ModItem>("SpiderKnife").Type, Valhalla.Find<ModItem>("TrueLightDisc").Type, Valhalla.Find<ModItem>("CorrodeShuriken").Type, Valhalla.Find<ModItem>("TerraGlaive").Type, Valhalla.Find<ModItem>("ToothKnife").Type, Valhalla.Find<ModItem>("HuskarJavelin").Type, Ava.Find<ModItem>("VirulentScythe").Type, Ava.Find<ModItem>("EnchantedShuriken").Type, Ava.Find<ModItem>("CrystalTomahawk").Type, Ava.Find<ModItem>("Icicle").Type, Ava.Find<ModItem>("TetanusChakram").Type, Ava.Find<ModItem>("Shurikerang").Type, ItemType<ValhalliteJavelin>(), ItemType<Selection>(), ItemType<DurataniumJavelin>(),  ItemType<GoldGlove>(), ItemType<OculithShard>(), ItemType<Blazes>(), ItemType<BlasphemousHeavens>(), ItemType<ThunderChakram>(), ItemType<JadeGlaive>(), ItemType<Ghalihieri>(), ItemType<Solarang>(), ItemType<InfamousFlame>(), ItemType<NaquadahJavelin>(), ItemType<Impact>()];
