...
namespace Vanilla.Content.Projectiles
{
	...
	{
		private const int MaxLifetime = 60 * 8; // live 8 seconds
		private float fadeOutPercent => 1f - (float)Projectile.timeLeft / MaxLifetime; // Процент завершения жизни (0-1)
