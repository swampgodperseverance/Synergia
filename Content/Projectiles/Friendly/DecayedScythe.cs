...
public class DecayedScytheProjectile : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        Dust dust = Dust.NewDustDirect(target, 0, 0, DustID.CorruptTorch);
        dust.noGravity = true;
        dust.alpha = 128;

        nextCloud++;
        int randomCloud = Main.rand.Next(new int[] { ModContent.ProjectileType<DecayedCloud>(), ModContent.ProjectileType<DecayedCloudSmall>() });
