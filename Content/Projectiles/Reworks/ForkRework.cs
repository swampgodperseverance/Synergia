...
{
    public class ForkRework : ModProjectile
    {
        private float glowRotation;
        private const float maxReach = 100f;
        private const float minReach = 40f;
        private bool hasSpawnedBloodSlash = false; // Флаг для отслеживания создания BloodSlash
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                // Создаем BloodSlashProjectile в середине анимации
                if (animProgress > 0.5f && !hasSpawnedBloodSlash) {
                    SpawnBloodSlash(player);
                    hasSpawnedBloodSlash = true;
                }
                // Сбрасываем флаг, когда анимация завершена
                else if (animProgress <= 0.5f) {
                    hasSpawnedBloodSlash = false;
                }
                ...
                if (Main.netMode != NetmodeID.Server) {
                    ...
                    for (int i = 0; i < 2; i++) {
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.Blood, 0f, 0f, 120);
                        dust.color = new Color(200, 0, 0); // Темно-красный цвет крови
        ...
        private void SpawnBloodSlash(Player player) {
            if (Main.myPlayer == Projectile.owner) {
                ...
                Projectile.NewProjectile(
                    ...
                    Projectile.Center,
                    velocity,
                    ModContent.ProjectileType<BloodSlashProjectile>(),
                    Projectile.damage / 1, 
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                Color glowColor = new Color(200, 0, 0, 120);
