...
{
    public class OrichalkumRework : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                if (Main.netMode != NetmodeID.Server) {
                    ...
                    for (int i = 0; i < 2; i++) {
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.PinkTorch, 0f, 0f, 120);
                        dust.color = new Color(200, 50, 120); // dark pink tone
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                // Dark pink glow
                Color glowColor = new Color(220, 70, 140, 120);
