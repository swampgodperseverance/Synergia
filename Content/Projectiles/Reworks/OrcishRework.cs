...
namespace Synergia.Content.Projectiles.Reworks
{
    public class OrcishRework : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust dust = Dust.NewDustPerfect(Projectile.Center + offset.ToRotationVector2() * (Main.rand.NextFloat() * 40f * Projectile.scale + 10f * Projectile.scale), 27, velocity * 1f, 50, new Color(200, 100, 230), 0.4f);
            ...
            {
                Dust dust2 = Dust.NewDustPerfect(position, 27, velocity * 1.5f, 100, new Color(220, 80, 255) * Projectile.Opacity, Projectile.Opacity);
        ...
        private void DrawLikeExcalibur(SpriteBatch spriteBatch)
        {
            ...
            Color value = Color.Lerp(new Color(80, 30, 120, 220), new Color(140, 40, 100, 220), lerpTime);
            ...
            Color value2 = Color.Lerp(new Color(120, 30, 100, 220), new Color(100, 30, 140, 220), lerpTime) * 1.25f;
            Color color = Color.Lerp(new Color(80, 30, 120, 220), new Color(150, 50, 170, 220), lerpTime) * 1.25f;

            Color value3 = Color.White * lerpTime * 0.3f;
            value3.A = (byte)(value3.A * (1f - lightningValue));
            Color value4 = value3 * lightningValue * 0.3f;
