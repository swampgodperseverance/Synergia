...
{
    public class BismuthumRework : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust dust = Dust.NewDustPerfect(Projectile.Center + offset.ToRotationVector2() * (Main.rand.NextFloat() * 45f * Projectile.scale + 15f * Projectile.scale), DustID.WhiteTorch, velocity * 1f, 50, new Color(255, 255, 255), 0.5f);
            ...
            {
                Dust dust2 = Dust.NewDustPerfect(position, DustID.WhiteTorch, velocity * 1.5f, 100, new Color(255, 255, 255) * Projectile.Opacity, Projectile.Opacity);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                {
                    Dust whiteDust = Dust.NewDustDirect(
                        Projectile.Center + Main.rand.NextVector2Circular(35f * Projectile.scale, 35f * Projectile.scale),
                        0, 0,
                        DustID.WhiteTorch,
        ...
        private void DrawLikeExcalibur(SpriteBatch spriteBatch)
        {
            ...
            Color value = Color.Lerp(new Color(200, 200, 200, 220), new Color(255, 255, 255, 220), lerpTime);
            ...
            Color value2 = Color.Lerp(new Color(220, 220, 220, 220), new Color(255, 255, 255, 220), lerpTime) * 1.25f;
            Color color = Color.Lerp(new Color(200, 200, 200, 220), new Color(255, 255, 255, 220), lerpTime) * 1.25f;
            ...
            for (float i = 0f; i < 12f; i += 1f)
            {
                ...
                float scale = i / 12f;
                DrawHelper.DrawPrettyStarSparkle(Projectile.Opacity, SpriteEffects.None, drawPos, Color.Lerp(new Color(255, 255, 255, 0), new Color(255, 255, 255, 0), percentageOfLife) * lerpTime * 2f * scale, color, percentageOfLife, 0f, 0.5f, 0.5f, 1f, edgeRotation, new Vector2(0f, Utils.Remap(percentageOfLife, 0f, 1f, 3f, 0f)) * scaleFactor, Vector2.One * scaleFactor);
            }
            ...
            DrawHelper.DrawPrettyStarSparkle(Projectile.Opacity, SpriteEffects.None, drawpos2, Color.Lerp(new Color(255, 255, 255, 0), new Color(255, 255, 255, 0), percentageOfLife) * lerpTime * 1.5f, color, percentageOfLife, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(percentageOfLife, 0f, 1f, 4f, 1f)) * scaleFactor, Vector2.One * scaleFactor);
        }
