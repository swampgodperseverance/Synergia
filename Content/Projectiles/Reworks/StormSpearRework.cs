...
{
    public class StormSpearRework : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                if (!shotFired && Projectile.ai[0] >= 3) {
                    Vector2 shootVel = Projectile.velocity.SafeNormalize(Vector2.UnitX) * 12f;
                    Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, shootVel, ProjectileID.ThunderSpearShot,
     Projectile.damage, Projectile.knockBack, player.whoAmI);
                ...
                if (Main.netMode != NetmodeID.Server) {
                    ...
                    for (int i = 0; i < 2; i++) {
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.Sandnado, 0f, 0f, 120);
                        ...
                        dust.noGravity = true;
                        dust.noLight = false;
                        dust.color = new Color(255, 200, 100, 180); 
                    }
                }
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                Color glowColor = new Color(255, 200 + k * 5, 100, 120 - k * 8); 
