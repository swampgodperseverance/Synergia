...
{
    public class PalladiumRework : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                if (Main.netMode != NetmodeID.Server) {
                    ...
                    for (int i = 0; i < 2; i++) {
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.OrangeTorch, 0f, 0f, 120);
                        dust.color = new Color(255, 140, 0); // Dark orange palladium color
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                // Dark orange palladium glow
                Color glowColor = new Color(255, 120, 30, 120);
