...
{
    public class SpearRework : ModProjectile
    {
        private float glowRotation;
        private const float maxReach = 80f; 
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                if (Main.netMode != NetmodeID.Server) {
                    ...
                    for (int i = 0; i < 2; i++) {
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.Iron, 0f, 0f, 120);
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                Color glowColor = new Color(150 + k * 10, 150 + k * 10, 150 + k * 10, 100 - k * 15);
