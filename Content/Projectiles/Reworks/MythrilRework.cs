...
{
    public class MythrilRework : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                if (Main.netMode != NetmodeID.Server) {
                    ...
                    for (int i = 0; i < 2; i++) {
                        // Mythril teal-cyan sparkles
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.Enchanted_Gold, 0f, 0f, 120);
                        dust.color = new Color(50, 255, 180); // Teal-green Mythril shine
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                // Mythril teal glow
                Color glowColor = new Color(80, 255, 200, 120);
