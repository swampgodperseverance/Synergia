...
{
    public class DwarvenBattleAxeRework : MaceTemplate
    {
        public override string Texture => "Bismuth/Content/Items/Weapons/Melee/DwarvenBattleAxe";
        public override string TrailTexture => "Synergia/Content/Projectiles/Reworks/AltUse/DwarvenBattleAxeRework_Trail";
        public override LocalizedText DisplayName => Language.GetText("Mods.Bismuth.Content.Items.DwarvenBattleAxe.DisplayName");
