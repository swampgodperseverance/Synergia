...
{
    public class NarsilRework : MaceTemplate
    {
        public override string Texture => "Bismuth/Content/Items/Weapons/Melee/Narsil";
        public override string TrailTexture => Texture;
        public override LocalizedText DisplayName => Language.GetText("Mods.Bismuth.Content.Items.Narsil.DisplayName");
        ...
        public override float SwingRadius => Projectile.ai[2] < 2 ? 110f : 80f;
