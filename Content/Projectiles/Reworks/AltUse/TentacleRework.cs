...
{
    public class TentacleSpikeRework : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (a >= 9 && a <= 15) Projectile.scale += localEmpowered ? 0.15f : 0.1f;
            if (a >= 15 && a <= 20) Projectile.scale -= localEmpowered ? 0.25f : 0.2f;
            ...
            float rotationMultiplier = localEmpowered ? 1.5f : 1.0f;
