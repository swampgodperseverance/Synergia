...
{
    public class SerialRework : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                if (Main.netMode != NetmodeID.Server) {
                    ...
                    for (int i = 0; i < 2; i++) {
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.Torch, 0f, 0f, 120, Color.Orange, 1f);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
            ...
            SpawnFlamingJack(target.Center);
        }
        ...
        private void SpawnFlamingJack(Vector2 position) {
            if (Main.myPlayer == Projectile.owner) {
                for (int i = 0; i < 3; i++) {
                    Vector2 velocity = new Vector2(Main.rand.NextFloat(-2f, 2f), Main.rand.NextFloat(-6f, -3f));
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                Color glowColor = new Color(255, 140, 0, 100 - k * 15); // оранжевый
