...
{
    public class CobaltRework : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                if (Main.netMode != NetmodeID.Server) {
                    ...
                    for (int i = 0; i < 2; i++) {
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.BlueTorch, 0f, 0f, 120);
                        dust.color = Color.DarkBlue; // cobalt coloring
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                // Dark cobalt-blue glow
                Color glowColor = new Color(30, 60, 200, 120);
