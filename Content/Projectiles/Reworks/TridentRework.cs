...
{
    public class TridentRework : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                if (Main.netMode != NetmodeID.Server)
                {
                    ...
                    for (int i = 0; i < 2; i++)
                    {
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.Water, 0f, 0f, 120);
                    ...
                    if (Main.rand.NextBool(5)) 
                    {
                        ...
                        Main.projectile[bubbleProj].timeLeft = 90; 
                    }
                }
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                Color glowColor = new Color(50, 150 + k * 7, 255, 120 - k * 8); 
