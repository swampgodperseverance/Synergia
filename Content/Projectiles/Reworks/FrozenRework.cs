...
{
    public class FrozenRework : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                // ❄️ СНЕЖНЫЕ частицы
                Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.Snow);
                dust.color = new Color(180, 220, 255); // голубовато-белый
                dust.velocity = origin.DirectionTo(dust.position) * 1.5f;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
            ...
            // ❄️ при попадании — снежные искры
            for (int i = 0; i < 5; i++) {
                Dust dust = Dust.NewDustDirect(target.position, target.width, target.height, DustID.Snow);
                dust.color = new Color(200, 240, 255); // яркий холодный белый
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                // ❄️ холодный голубой трейл
                Color glowColor = new Color(150, 200, 255, 180);
