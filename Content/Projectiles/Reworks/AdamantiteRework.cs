...
{
    public class AdamantiteRework : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                if (Main.netMode != NetmodeID.Server) {
                    ...
                    for (int i = 0; i < 2; i++) {
                        // Adamantite red-magenta sparkle
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.Firework_Red, 0f, 0f, 120);
                        dust.color = new Color(220, 50, 80); // deep crimson with slight magenta tint
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                // Adamantite fiery-magenta glow
                Color glowColor = new Color(255, 60, 100, 150);
