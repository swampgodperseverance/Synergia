...
{
    public class TitaniumRework : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (!player.frozen) {
                ...
                if (Main.netMode != NetmodeID.Server) {
                    ...
                    for (int i = 0; i < 2; i++) {
                        Dust dust = Dust.NewDustDirect(Projectile.Center, 14, 14, DustID.Silver, 0f, 0f, 120);
                        dust.color = new Color(180, 180, 200); // steel-gray
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            for (int k = 0; k < Projectile.oldPos.Length - 1; k++) {
                ...
                // Titanium steel-gray glow
                Color glowColor = new Color(200, 200, 210, 120);
