...
namespace Synergia.Content.Projectiles.Aura
{
	...
	public class PathogenicAuraSpawn : AuraDamageAI
	{
		...
		public override void CustomAI()
		{
			...
			int dustIndex = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.CursedTorch, Projectile.velocity.X * 0.1f, Projectile.velocity.Y * 0.1f, 150, default, 1.2f);
			...
			for (int i = 0; i < 4; i++)
			{
				...
				DustID.CursedTorch, Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f,
				100, default, 1.2f);
			}
		...
		public override void OnKill(int timeLeft)
		{
			...
			{
					Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.CursedTorch, Projectile.velocity.X * 0.01f, Projectile.velocity.Y * 0.01f, 150, default, 1.2f);
			}
		}
	}
}