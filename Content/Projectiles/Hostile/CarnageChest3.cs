...
{
    public class CarnageChest3 : ModProjectile
    {
        ...
        private int shotsPerFan = 3;
        private float fanSpreadAngle = 0.4f;
        ...
        public override void AI()
        {
            if (Projectile.ai[0] >= 0 && Projectile.ai[0] < Main.maxNPCs)
            {
                ...
                if (boss.active && boss.life > 0)
                {
                    ...
                    // НЕ возвращаем из Fading в ClosedIdle, сундук должен исчезать плавно
                }
                else
                {
        ...
        {
            if (stateTimer % (int)timeBetweenShots == 0)
            {
        ...
        private void ShootInFanPattern(int fanDirection, int shotIndex)
        {
            ...
            Projectile.NewProjectile(
                ...
                Projectile.Center,
                velocity,
                ModContent.ProjectileType<CarnageBone>(),
                Projectile.damage,
                0f,
                Projectile.owner
            );
