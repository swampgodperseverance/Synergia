    ...
    public class Skelegon : ModNPC
    {
        ...
        public override void OnKill()
        {
            ...
            for (int i = 0; i < Main.rand.Next(3, 5); i++) {
                Projectile.NewProjectile(NPC.GetSource_Death(), center, Main.rand.NextVector2Circular(9f, 9f), ProjectileType<Projectiles.Hostile.SkelegonProj3>(), 25, 2f);
            }
            Projectile.NewProjectile(NPC.GetSource_Death(), center, Main.rand.NextVector2Circular(8f, 8f), ProjectileType<Projectiles.Hostile.SkelegonProj1>(), 30, 2f);
            Projectile.NewProjectile(NPC.GetSource_Death(), center, Main.rand.NextVector2Circular(8f, 8f), ProjectileType<Projectiles.Hostile.SkelegonProj2>(), 30, 2f);
        }
    }
}
