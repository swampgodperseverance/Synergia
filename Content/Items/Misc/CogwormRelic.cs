...
namespace Synergia.Content.Items.Misc
{
	...
	public class CogwormRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "Synergia/Content/Items/Misc/CogwormRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "Synergia/Content/Items/Misc/RelicPedestal";
