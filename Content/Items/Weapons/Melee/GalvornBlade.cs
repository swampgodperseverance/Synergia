...
namespace Synergia.Content.Items.Weapons.Melee {
    public class GalvornBladeData : ModPlayer {
        public bool GalvornBladeIsUsed { get; internal set; }

        public override void PostUpdate() {
            if (Player.inventory[Player.selectedItem].type == ModContent.ItemType<GalvornBlade>() && Player.ItemAnimationJustStarted) {
                GalvornBladeIsUsed = !GalvornBladeIsUsed;
            }
        }
    }
    ...
    public class GalvornBlade : ModItem {
        ...
        public override void SetDefaults() {
            ...
            Item.shoot = ModContent.ProjectileType<Content.Projectiles.Reworks.GalvornBladeRework>();
            Item.shootSpeed = 14f;
        }
