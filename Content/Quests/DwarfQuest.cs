...
namespace Synergia.Content.Quests
{
    public class DwarfQuest : BaseQuestLogic {
        ...
        public override void OnChatButtonClicked(Player player) {
            ...
            CheckItem(player, ref player.GetModPlayer<QuestBoolean>().DwarfQuest, ModContent.ItemType<DwarvenAnvil>(), 1, 1, LocQuestKey("Dwarf", "QuestCompleted"), LocQuestKey("Dwarf", "QuestCompletedFalse"), ModContent.ItemType<ValhalliteOre>(), RandomValue(45, 60));
        }
