...
namespace Synergia.Content.Quests {
    public class DwarfQuest_Second : BaseQuestLogic {
        ...
        public override void OnChatButtonClicked(Player player) {
            ...
            CheckItem(player, ref player.GetModPlayer<QuestBoolean>().DwarfQuest2, ItemType<OldDwarvenHelmet>(), 1, 1, LocQuestKey("DwarfQuest_Second", "QuestCompleted"), LocQuestKey("DwarfQuest_Second", "QuestCompletedFalse"), ItemType<FrostyTruffle>(), 1);
