...
namespace Synergia.Content.Quests {
    public class LibrarianQuest : BaseQuestLogic {
        ...
        public override int CornerItem => ItemType<TatteredBook>(); // DamagedBook
        ...
        public override void OnChatButtonClicked(Player player) {
            ...
            CheckItem(player, ref player.GetModPlayer<QuestBoolean>().LibrarianQuest, ItemType<TatteredBook>(), 1, 1, LocQuestKey("Librarian", "QuestCompleted"), LocQuestKey("Librarian", "QuestCompletedFalse"), ItemType<WaterCandelabra>());
