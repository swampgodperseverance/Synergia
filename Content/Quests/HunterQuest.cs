...
namespace Synergia.Content.Quests {
    public class HunterQuest : BaseQuestLogic {
        ...
        public override void OnChatButtonClicked(Player player) {
            ...
            CheckItem(player, ref player.GetModPlayer<QuestBoolean>().HunterQuest, ModContent.ItemType<DwarvenAnvil>(), 1, 1, LocQuestKey("Hunter", "QuestCompleted"), LocQuestKey("Hunter", "QuestCompletedFalse"), ModContent.ItemType<SurfandTurf>());
            if (Progress == 0) {
