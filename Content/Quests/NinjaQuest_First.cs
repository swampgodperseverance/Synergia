...
namespace Synergia.Content.Quests {
    public class NinjaQuest_First : BaseQuestLogic {
        ...
        public override void OnChatButtonClicked(Player player) {
            ...
            CheckItem(player, ref player.GetModPlayer<QuestBoolean>().NinjaQuest1, ItemType<LothorSkull>(), 1, 1, LocQuestKey("NinjaQuest_Frist", "QuestCompleted"), LocQuestKey("NinjaQuest_Frist", "QuestCompletedFalse"), ItemType<FakeFourLeafClover>(), 3);
