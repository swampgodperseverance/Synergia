...
{
    public class ValhalliteSwordGI : GlobalItem
    {
        ...
        public override bool AppliesToEntity(Item item, bool lateInstantiation)
        {
            ...
            return string.Equals(item.ModItem.Mod?.Name, "ValhallaMod", StringComparison.OrdinalIgnoreCase)
                && string.Equals(item.ModItem.Name, "ValhalliteSword", StringComparison.OrdinalIgnoreCase);
        }
        ...
        public override void SetDefaults(Item item)
        {
            ...
            item.shoot = ModContent.ProjectileType<ValhalliteSwordRework>();
        }
