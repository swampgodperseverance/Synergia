...
{
    public class GladiusGI : GlobalItem
    {
        ...
        public override bool AppliesToEntity(Item item, bool lateInstantiation)
        {
            ...
            return string.Equals(item.ModItem.Mod?.Name, "Bismuth", StringComparison.OrdinalIgnoreCase)
                && string.Equals(item.ModItem.Name, "Gladius", StringComparison.OrdinalIgnoreCase);
        }
        ...
        public override void SetDefaults(Item item)
        {
            ...
            item.channel = true;
            item.useStyle = 5;
            item.shoot = ModContent.ProjectileType<GladiusBismuth>();
            item.useTurn = false;
        }
        public override bool Shoot(Item item, Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                Projectile.NewProjectileDirect(source, position, velocity, ModContent.ProjectileType<GladiusBismuth>(), damage, knockback, player.whoAmI, 0f, this.XZ ? 1f : -1f, 0f).ai[1] = (this.XZ ? 1f : -1f);
                this.XZ = !this.XZ;
                return false;
            }
        }
