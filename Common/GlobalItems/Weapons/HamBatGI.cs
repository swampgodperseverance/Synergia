...
{
    public class HamBatGI : GlobalItem
    {
        ...
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            return entity.type == ItemID.HamBat;
        }
        public override void SetDefaults(Item item)
        {
            ...
            item.shoot = ModContent.ProjectileType<HamBatRework>();
            item.channel = true;
        ...
        {
            return player.ownedProjectileCounts[ModContent.ProjectileType<HamBatRework>()] < 1;
        }
        ...
        {
            int idx = Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<HamBatRework>(), damage, knockback, player.whoAmI);
        ...
        {
            var mp = player.GetModPlayer<HamBatPlayer>();
            if (mp != null && mp.HamBatEmpowered)
                item.damage = 80;
            else
                item.damage = 35;
    ...
    public class HamBatPlayer : ModPlayer
    {

        public int HamBatHitCount = 0;
        public bool HamBatEmpowered = false;
        ...
        {
            tag["HamBatHitCount"] = HamBatHitCount;
            tag["HamBatEmpowered"] = HamBatEmpowered;
        }

        public override void LoadData(TagCompound tag)
        {
            if (tag.ContainsKey("HamBatHitCount")) HamBatHitCount = tag.GetInt("HamBatHitCount");
            if (tag.ContainsKey("HamBatEmpowered")) HamBatEmpowered = tag.GetBool("HamBatEmpowered");
        }
    }
}
