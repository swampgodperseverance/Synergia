...
if (npc.TypeName == GetTextValue("Mods.Liber.NPCs.GolemFire.DisplayName") || npc.FullName == GetTextValue("Mods.Liber.NPCs.GolemFire.DisplayName"))
{
npcLoot.Add(
ItemDropRule.Common(	
avalon.Find<ModItem>("FireShard").Type,
...
if (npc.TypeName == GetTextValue("Mods.Liber.NPCs.MagmaMammoth.DisplayName") || npc.FullName == GetTextValue("Mods.Liber.NPCs.ZombieBlistered.DisplayName"))
{
npcLoot.Add(
ItemDropRule.Common(	
avalon.Find<ModItem>("FireShard").Type,
...
if (npc.TypeName == GetTextValue("Mods.Liber.NPCs.Fireman.DisplayName") || npc.FullName == GetTextValue("Mods.Liber.NPCs.Fireman.DisplayName"))
{
npcLoot.Add(
ItemDropRule.Common(	
avalon.Find<ModItem>("FireShard").Type,
...
if (npc.TypeName == GetTextValue("Mods.Liber.NPCs.Burnt.DisplayName") || npc.FullName == GetTextValue("Mods.Liber.NPCs.Burnt.DisplayName"))
{
npcLoot.Add(
ItemDropRule.Common(	
avalon.Find<ModItem>("FireShard").Type,
