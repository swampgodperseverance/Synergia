...
if (npc.TypeName == GetTextValue("Mods.Liber.NPCs.ZombieBloated.DisplayName") || npc.FullName == GetTextValue("Mods.Liber.NPCs.ZombieBloated.DisplayName"))
{
npcLoot.Add(
ItemDropRule.Common(	
avalon.Find<ModItem>("CorruptShard").Type,
...
if (npc.TypeName == GetTextValue("Mods.Liber.NPCs.ZombieBlistered.DisplayName") || npc.FullName == GetTextValue("Mods.Liber.NPCs.ZombieBlistered.DisplayName"))
{
npcLoot.Add(
ItemDropRule.Common(	
avalon.Find<ModItem>("CorruptShard").Type,
...
if (npc.TypeName == GetTextValue("Mods.Liber.NPCs.SprigganCorrupt.DisplayName") || npc.FullName == GetTextValue("Mods.Liber.NPCs.SprigganCorrupt.DisplayName"))
{
npcLoot.Add(
ItemDropRule.Common(	
avalon.Find<ModItem>("CorruptShard").Type,
...
if (npc.TypeName == GetTextValue("Mods.Liber.NPCs.SprigganCrimson.DisplayName") || npc.FullName == GetTextValue("Mods.Liber.NPCs.SprigganCrimson.DisplayName"))
{
npcLoot.Add(
ItemDropRule.Common(	
avalon.Find<ModItem>("CorruptShard").Type,
